...
["", "gameoflife.dart", , Z, {
  ...
  main: [function() {
    ...
    svg_world = document.querySelector("#svg_world");
    t1 = J.get$onClick$x(document.querySelector("#start"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#stop"));
    ...
    t1 = J.get$onClick$x(document.querySelector("#step"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.main_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#new"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.main_closure2(svg_world)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#new_empty"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Z.main_closure3(svg_world)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    Z.initWorldView(svg_world);
  }, "call$0", "main$closure", 0, 0, 10],
  startGame: function() {
    var t1 = {};
    J.set$innerHtml$x($.statusElement, "Game started ...");
    t1.i_0 = 0;
    $.timer = P.Timer_Timer$periodic($.get$sleepDuration(), new Z.startGame_closure(t1));
  },
  initWorldView: function(svgWorld) {
    var y_on_svg, _y, x_on_svg, _x, temp, t1, t2, t3, t4, t5, t6;
    for (y_on_svg = 0, _y = 0; _y < 60; ++_y) {
      for (x_on_svg = 0, _x = 0; _x < 100; ++_x) {
        temp = document.createElementNS("http://www.w3.org/2000/svg", "rect");
        temp.id = "id" + _x + "_" + _y;
        temp.setAttribute("x", "" + x_on_svg);
        temp.setAttribute("y", "" + y_on_svg);
        temp.setAttribute("height", "10");
        temp.setAttribute("width", "10");
        temp.setAttribute("stroke", "lightgray");
        t1 = $.get$game()._world;
        if (_y >= t1.length)
          return H.ioore(t1, _y);
        temp.setAttribute("fill", J.$index$asx(t1[_y], _x) === true ? "#0000FF" : "#00FFFF");
        t2 = J.getInterceptor$x(temp);
        t3 = t2.get$onMouseDown(temp);
        t4 = t3._eventType;
        t5 = t3._useCapture;
        t6 = new W._EventStreamSubscription(0, t3._target, t4, W._wrapZone(new Z.initWorldView_closure()), t5);
        t6.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
        t1 = t6._onData;
        if (t1 != null && t6._pauseCount <= 0)
          J.addEventListener$3$x(t6._target, t4, t1, t5);
        t1 = t2.get$onMouseUp(temp);
        t3 = t1._eventType;
        t4 = t1._useCapture;
        t5 = new W._EventStreamSubscription(0, t1._target, t3, W._wrapZone(new Z.initWorldView_closure0()), t4);
        t5.$builtinTypeInfo = [H.getTypeArgumentByIndex(t1, 0)];
        t1 = t5._onData;
        if (t1 != null && t5._pauseCount <= 0)
          J.addEventListener$3$x(t5._target, t3, t1, t4);
        t1 = t2.get$onMouseOver(temp);
        t2 = t1._eventType;
        t3 = t1._useCapture;
        t4 = new W._EventStreamSubscription(0, t1._target, t2, W._wrapZone(new Z.initWorldView_closure1()), t3);
        t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t1, 0)];
        t1 = t4._onData;
        if (t1 != null && t4._pauseCount <= 0)
          J.addEventListener$3$x(t4._target, t2, t1, t3);
        $.get$worldCellMap().$indexSet(0, temp.id, temp);
        svgWorld.appendChild(temp);
        x_on_svg += 10;
      }
      y_on_svg += 10;
    }
  ...
  refreshWorldView: function() {
    var t1, y, x, _y, _x, cell_id, t2;
    t1 = $.get$game()._world;
    y = t1.length;
    if (0 >= y)
      return H.ioore(t1, 0);
    x = J.get$length$asx(t1[0]);
    for (_y = 0; _y < y; ++_y) {
      if (typeof x !== "number")
        return H.iae(x);
      _x = 0;
      for (; _x < x; ++_x) {
        cell_id = "id" + _x + "_" + _y;
        t1 = J.get$attributes$x($.get$worldCellMap().$index(0, cell_id));
        t2 = $.get$game()._world;
        if (_y >= t2.length)
          return H.ioore(t2, _y);
        t2 = J.$index$asx(t2[_y], _x) === true ? "#0000FF" : "#00FFFF";
        t1._element.setAttribute("fill", t2);
      }
    }
  },
  editWorld: function(e) {
    var t1, split, w_x, w_y, t2;
    $.mouseDown = true;
    t1 = "Edit cell: " + H.S(J.get$id$x(J.get$currentTarget$x(e)));
    J.set$innerHtml$x($.statusElement, t1);
    split = J.split$1$s(J.get$id$x(W._convertNativeToDart_EventTarget(e.currentTarget)), "_");
    if (0 >= split.length)
      return H.ioore(split, 0);
    w_x = H.Primitives_parseInt(J.substring$1$s(split[0], 2), null, null);
    if (1 >= split.length)
      return H.ioore(split, 1);
    w_y = H.Primitives_parseInt(split[1], null, null);
    t1 = $.get$game()._world;
    if (w_y >>> 0 !== w_y || w_y >= t1.length)
      return H.ioore(t1, w_y);
    t1 = t1[w_y];
    J.$indexSet$ax(t1, w_x, J.$index$asx(t1, w_x) !== true);
    t1 = J.get$attributes$x(W._convertNativeToDart_EventTarget(e.currentTarget));
    t2 = $.get$game()._world;
    if (w_y >= t2.length)
      return H.ioore(t2, w_y);
    t2 = J.$index$asx(t2[w_y], w_x) === true ? "#0000FF" : "#00FFFF";
    t1._element.setAttribute("fill", t2);
  },
  main_closure: {
    "": "Closure:12;",
  ...
  main_closure0: {
    ...
    call$1: function(e) {
      var t1 = $.timer;
      return t1 != null ? t1.cancel$0() : "";
    }
  },
  main_closure1: {
    "": "Closure:12;",
    call$1: function(e) {
      $.get$game().recalculateWorld$0();
      Z.refreshWorldView();
      return;
    }
  },
  main_closure2: {
    "": "Closure:12;svg_world_0",
    call$1: function(e) {
      var t1 = $.timer;
      if (t1 != null)
        t1.cancel$0();
      $.game = E.GameOfLife$(100, 60);
      Z.initWorldView(this.svg_world_0);
      J.set$innerHtml$x($.statusElement, "Random World is Ready");
    }
  },
  main_closure3: {
    "": "Closure:12;svg_world_1",
    call$1: function(e) {
      var t1 = $.timer;
      if (t1 != null)
        t1.cancel$0();
      t1 = new E.GameOfLife(null, null, null, null);
      t1.GameOfLife$myWorld$1(E.createWorld(100, 60, 0, true));
      $.game = t1;
      Z.initWorldView(this.svg_world_1);
      J.set$innerHtml$x($.statusElement, "Empty World is Ready");
    }
  },
  startGame_closure: {
    "": "Closure:12;box_0",
    call$1: function(t) {
      ...
      if (!$.mouseDown) {
        ...
        if (t2 > 1000) {
          t.cancel$0();
          J.set$innerHtml$x($.statusElement, "... Finished");
        }
      }
    }
  },
  initWorldView_closure: {
    "": "Closure:12;",
    call$1: function(e) {
      return Z.editWorld(e);
    }
  },
  initWorldView_closure0: {
    "": "Closure:12;",
    call$1: function(e) {
      $.mouseDown = false;
      return false;
  ...
  initWorldView_closure1: {
    "": "Closure:12;",
    call$1: function(e) {
      return $.mouseDown ? Z.editWorld(e) : "";
    }
  }
},
1],
["gameoflife_algorithm", "gameoflife_algorithm.dart", , E, {
  "": "",
  createWorld: function(x, y, random_activations, createEmptyWorld) {
    return P.List_List$generate(y, new E.createWorld_closure(x, random_activations, createEmptyWorld), true, [J.JSArray, J.JSBool]);
  },
  GameOfLife: {
    "": "Object;_WORLD_X,_WORLD_Y,_world,_tempWorld",
    recalculateWorld$0: function() {
      var y, t1, x, t2;
      for (y = 0; t1 = this._world, y < t1.length; ++y) {
        x = 0;
        while (true) {
          t1 = this._world;
          if (y >= t1.length)
            return H.ioore(t1, y);
          t1 = J.get$length$asx(t1[y]);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (!(x < t1))
            break;
          ...
          if (y >= t2.length)
            return H.ioore(t2, y);
          J.$indexSet$ax(t1, x, this._calculateNewState$3(y, x, J.$index$asx(t2[y], x)));
          ++x;
        }
      }
      this._world = this._tempWorld;
      this._tempWorld = t1;
    },
    _calculateNewState$3: function(y, x, currentState) {
      var t1, t2, t3, t4, t5, n, s, o, w, t6, no, so, sw, nw, livingNeighbor;
      t1 = this._world;
      t2 = t1.length;
      if (y >= t2)
        return H.ioore(t1, y);
      ...
      if (t3) {
        ...
        n = J.$index$asx(t4[t5], x) === true ? 1 : 0;
      } else
        n = 0;
      t2 = y < t2 - 1;
      if (t2) {
        ...
        if (t5 >= t4.length)
          return H.ioore(t4, t5);
        s = J.$index$asx(t4[t5], x) === true ? 1 : 0;
      } else
        s = 0;
      t1 = x < t1 - 1;
      if (t1) {
        ...
        if (y >= t4.length)
          return H.ioore(t4, y);
        o = J.$index$asx(t4[y], x + 1) === true ? 1 : 0;
      } else
        o = 0;
      t4 = x > 0;
      if (t4) {
        ...
        if (y >= t5.length)
          return H.ioore(t5, y);
        w = J.$index$asx(t5[y], x - 1) === true ? 1 : 0;
      } else
        w = 0;
      if (t3 && t1) {
        t5 = this._world;
        ...
        no = J.$index$asx(t5[t6], x + 1) === true ? 1 : 0;
      } else
        no = 0;
      if (t2 && t1) {
        t1 = this._world;
        ...
        so = J.$index$asx(t1[t5], x + 1) === true ? 1 : 0;
      } else
        so = 0;
      if (t2 && t4) {
        t1 = this._world;
        ...
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        sw = J.$index$asx(t1[t2], x - 1) === true ? 1 : 0;
      } else
        sw = 0;
      if (t3 && t4) {
        t1 = this._world;
        ...
        if (t2 < 0 || t2 >= t1.length)
          return H.ioore(t1, t2);
        nw = J.$index$asx(t1[t2], x - 1) === true ? 1 : 0;
      } else
        nw = 0;
      livingNeighbor = n + nw + w + sw + s + so + o + no;
    ...
    toString$0: function(_) {
      var sb, y, x, t1;
      sb = P.StringBuffer$("");
      for (y = 0; y < this._world.length; ++y) {
        x = 0;
        while (true) {
          t1 = this._world;
          if (y >= t1.length)
    ...
    GameOfLife$myWorld$1: function(myWorld) {
      var t1;
      this._world = myWorld;
      t1 = myWorld.length;
      this._WORLD_Y = t1;
      if (0 >= t1)
        return H.ioore(myWorld, 0);
      t1 = J.get$length$asx(myWorld[0]);
      this._WORLD_X = t1;
      this._tempWorld = E.createWorld(t1, this._WORLD_Y, 0, true);
    },
    GameOfLife$2: function(_WORLD_X, _WORLD_Y) {
      this._world = E.createWorld(this._WORLD_X, this._WORLD_Y, 30, false);
      this._tempWorld = E.createWorld(this._WORLD_X, this._WORLD_Y, 0, true);
    },
    static: {GameOfLife$: function(_WORLD_X, _WORLD_Y) {
        var t1 = new E.GameOfLife(_WORLD_X, _WORLD_Y, null, null);
        t1.GameOfLife$2(_WORLD_X, _WORLD_Y);
        return t1;
      }}
  },
  createWorld_closure: {
    "": "Closure:20;x_0,random_activations_1,createEmptyWorld_2",
    call$1: function(y_idx) {
      var t1 = this.x_0;
      if (this.createEmptyWorld_2)
        return P.List_List$filled(t1, false, J.JSBool);
      else
        return P.List_List$generate(t1, new E.createWorld__closure(this.random_activations_1), true, J.JSBool);
    }
  },
  createWorld__closure: {
    "": "Closure:20;random_activations_3",
    call$1: function(x_idx) {
      return $.get$shaker().nextInt$1(100) < this.random_activations_3;
    }
  }
}],
]);
...
Isolate.$lazy($, "sleepDuration", "sleepDuration", "get$sleepDuration", function() {
  return P.Duration$(0, 0, 0, 200, 0, 0);
});
Isolate.$lazy($, "worldCellMap", "worldCellMap", "get$worldCellMap", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
});
Isolate.$lazy($, "game", "game", "get$game", function() {
  return E.GameOfLife$(100, 60);
});
Isolate.$lazy($, "shaker", "shaker", "get$shaker", function() {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure2(svg_world_0) {
    this.svg_world_0 = svg_world_0;
  }
  ...
  function main_closure3(svg_world_1) {
    this.svg_world_1 = svg_world_1;
  }
